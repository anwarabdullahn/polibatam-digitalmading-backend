        ...
        <div id="page-wrapper" class="page-loading">
                                    ...
                                    <tbody>
                                      @foreach ($banners as $index=> $banner)
                                          <tr>
                                            ...
                                            <td class="text-center" style="width: 230px;"><div class="btn-group pull-right" role="group"><button type="button" class="edit-banner btn btn-inline btn-primary" data-toggle="modal" data-target="#edit-banner" data-edit-id="{{$banner->id}}" data-edit-title="{{$banner->title}}" data-edit-status="{{$banner->status}}"><i class="fa fa-edit"></i>Ubah</button>
                                            <button type="button" class="hapus-banner btn btn-inline btn-danger" data-toggle="modal" data-target="#hapus-banner" data-hapus-id="{{ $banner->id }}" data-hapus-title="{{ $banner->title }}"><i class="fa fa-trash"></i>Hapus</button>
          ...
          <div class="modal fade" id="edit-banner">
                ...
                <form class="fieldset-form form-horizontal" action="{{ url('/banner')}}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                          <fieldset>
                            <legend class="text-center" style="color: #33577A; font-size: 21px !important;">EDIT BANNER</legend>
                                  @foreach ($errors->add->all() as $error)
                                    <div class="alert alert-danger display-show">
                                      {{ $error }}
                                    </div>

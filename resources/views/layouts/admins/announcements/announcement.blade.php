          ...
          <div class="preloader">
                ...
                {{ csrf_field() }}
                        <fieldset>
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" name="description" placeholder="Type your description..." value="">{{old('description')}}</textarea>
                          </div>
            ...
            <div class="modal fade" id="edit-announcement">
                ...
                <form class="fieldset-form" action="{{ url('/announcement/update')}}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                          <fieldset>
                            <legend class="text-center" style="color: #33577A; font-size: 21px !important;">UBAH ANOUNCEMENT</legend>
